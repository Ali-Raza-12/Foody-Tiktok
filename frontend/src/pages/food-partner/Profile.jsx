...
import { ArrowLeft, Settings, Share, Plus, Play, Heart, MessageCircle, MoreHorizontal, Edit } from 'lucide-react';
...
const Profile = () => {
  ...
  const userProfile = {
    ...
    bio: "Professional chef sharing authentic Italian recipes 🇮🇹 | 15+ years experience | Follow for daily cooking tips",
    followers: 145600,
    following: 892,
    likes: 2400000,
    verified: true
  ...
  const userVideos = [
    ...
    {
      id: 2,
      thumbnail: "https://images.unsplash.com/photo-1572441713132-51c75654db73?w=300&h=400&fit=crop",
      views: "890K",
      duration: "1:20",
    ...
    {
      id: 3,
      thumbnail: "https://images.unsplash.com/photo-1563379091339-03246963d51a?w=300&h=400&fit=crop",
      views: "2.1M",
      duration: "0:38",
    ...
    {
      id: 4,
      thumbnail: "https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=300&h=400&fit=crop",
      views: "657K",
      duration: "1:05",
    ...
    {
      id: 6,
      thumbnail: "https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=300&h=400&fit=crop",
      views: "934K",
      duration: "1:15",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white pb-6">
        <div className="px-6 pt-6">
            ...
            <div className="flex-1 pt-2">
              ...
              <div className="flex space-x-6">
                <div className="text-center">
                  <div className="text-xl font-bold text-gray-900">{formatNumber(userProfile.followers)}</div>
                  <div className="text-sm text-gray-600">Followers</div>
                </div>
                <div className="text-center">
                  <div className="text-xl font-bold text-gray-900">{formatNumber(userProfile.following)}</div>
                  <div className="text-sm text-gray-600">Following</div>
                </div>
                <div className="text-center">
                  <div className="text-xl font-bold text-gray-900">{formatNumber(userProfile.likes)}</div>
          ...
          {/* Bio */}
          <p className="text-gray-700 mb-4 leading-5">{userProfile.bio}</p>
        ...
        {activeTab === 'videos' && (
          <div className="grid grid-cols-3 gap-1">
            {userVideos.map((video) => (
              <div key={video.id} className="relative aspect-[9/16] bg-gray-200 rounded-lg overflow-hidden group cursor-pointer">
                <img 
                  src={video.thumbnail} 
                  alt={video.title}
